...
document.getElementsByClassName("guide-item-zx")[0].onmouseover = function(){
	this.className = "guide-item guide-item-zx";
	this.innerText = "资讯";
}
document.getElementsByClassName("guide-item-zx")[0].onmouseout = function(){
	this.className = "guide-item guide-item-zx iconfont icon-zixun";
	this.innerText = "";
}